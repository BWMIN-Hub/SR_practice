...
# ==============================================================================
"""업스트림 imgproc.py 사본. 한 글자도 고치지 않았다.

MATLAB 호환 bicubic(`image_resize`)과 rgb2ycbcr 이 필요해서 그대로 가져왔다.
학습할 때 쓴 것과 같은 함수여야 추론 결과가 맞는다.

원본: https://github.com/Lornatang/SRCNN-PyTorch/blob/main/imgproc.py
"""
import math
import random
